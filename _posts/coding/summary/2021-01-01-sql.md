...
- [1294. Weather Type in Each Country (E)](#1294-weather-type-in-each-country-e)
...
- `AVG()` will not count `NULL` values.
...
Using `OUTER JOIN` and `COUNT(expression)`
